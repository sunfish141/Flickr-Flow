...
export default function App() {
  ...
  return <>
    ...
    <dialog id="help-dialog" ref={help} aria-labelledby="help-title"><button id="close-help" className="icon-button" aria-label="Close instructions" onClick={() => help.current.close()}>×</button>
      ...
      <h3>Research limitations</h3><p>One possible simulation, not an operational forecast. No weather inputs; uniform simulated fuel burns out within two steps after ignition. Intensity is a scenario scale, not fire radiative power. Small waterways may be missed. Evaluation covers 12–96 hours; longer playback does not establish accuracy. Follow local emergency authorities.</p>
