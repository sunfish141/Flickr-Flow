...
- **One map:** Black Hawk and Hinton are always outlined and labelled. Their
...
- **Offline overview:** bundled Natural Earth land/lakes provide orientation even
  without map tiles. Detailed land cover/roads exist only inside the two 9 × 9 km
  installed regions. Offline, new placements elsewhere explain that regional
